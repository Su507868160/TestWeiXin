<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"/phpstudy/www/bolg/public/../application/admin/view/login/login.html";i:1509162669;}*/ ?>
<!DOCTYPE html>
    ...
    <div class="login-container animated fadeInDown">
        <form action="<?php echo url('admin/Login/login'); ?>" method="post">
            <div class="loginbox bg-white">
                ...
                <div class=""style="margin: 40px auto 20px 40px;">
                    <button>短信验证</button>
                </div>
                ...
                <div class=""style="margin: 0px auto 20px 40px;">
                    <button>邮箱验证</button>
                </div>
