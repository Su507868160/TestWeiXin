<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:66:"F:\wamp64\www\bolg\public/../application/admin\view\index\col.html";i:1508460501;s:67:"F:\wamp64\www\bolg\public/../application/admin\view\common\top.html";i:1508687318;s:68:"F:\wamp64\www\bolg\public/../application/admin\view\common\left.html";i:1508638283;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
...
<button type="button" tooltip="添加管理员" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('admin/Index/add'); ?>'"> <i class="fa fa-plus"></i> Add
</button>
<div class="row">
                    ...
                    <table class="table table-bordered table-hover">
                        <thead class="">
                            <tr>
                                ...
                                <th class="text-center" width="70%">管理员名称</th>
                        ...
                        <?php foreach($list as $v): ?>
                             <tr>
                                ...
                                <td align="center">
                                    <a href="<?php echo url('admin/Index/edit',array('id'=>$v['id'])); ?>" class="btn btn-primary btn-sm shiny">
                                        <i class="fa fa-edit"></i> 编辑
                                    </a>
                                    <a href="#" onClick="warning('确实要删除吗', '<?php echo url('admin/Index/del',array('id'=>$v['id'])); ?>')" class="btn btn-danger btn-sm shiny">
