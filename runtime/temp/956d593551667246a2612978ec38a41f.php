<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:67:"F:\wamp64\www\bolg\public/../application/admin\view\index\edit.html";i:1508423197;s:67:"F:\wamp64\www\bolg\public/../application/admin\view\common\top.html";i:1508687318;s:68:"F:\wamp64\www\bolg\public/../application/admin\view\common\left.html";i:1508638283;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
        ...
        <div class="widget">
            ...
            <div class="widget-body">
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="<?php echo url('admin/Index/edit'); ?>" method="post">
                        <input type="hidden" name="id" value="<?php echo $admin['id']; ?>">
                        <div class="form-group">
                            <label for="username" class="col-sm-2 control-label no-padding-right">用户名</label>
                            <div class="col-sm-6">
                                <input class="form-control" id="username" placeholder="" name="username" required="" type="text" value="<?php echo $admin['username']; ?>">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>

                        <div class="form-group">
                            <label for="username" class="col-sm-2 control-label no-padding-right">密&nbsp;&nbsp;&nbsp;&nbsp;码</label>
                            <div class="col-sm-6">
